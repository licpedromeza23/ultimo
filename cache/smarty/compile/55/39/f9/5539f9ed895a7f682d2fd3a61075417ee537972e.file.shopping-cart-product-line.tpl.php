<?php /* Smarty version Smarty-3.1.19, created on 2016-08-11 21:30:05
         compiled from "C:\xampp\htdocs\ultimo\themes\default-bootstrap\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1180157acd23d6cd571-80774174%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5539f9ed895a7f682d2fd3a61075417ee537972e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\ultimo\\themes\\default-bootstrap\\shopping-cart-product-line.tpl',
      1 => 1466020876,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1180157acd23d6cd571-80774174',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57acd23da70998_06063903',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57acd23da70998_06063903')) {function content_57acd23da70998_06063903($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\ultimo\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_regex_replace')) include 'C:\\xampp\\htdocs\\ultimo\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
<?php $_tmp38=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product_attribute']);?>
<?php $_tmp39=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
<?php $_tmp40=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp38."&amp;ipa=".$_tmp39."&amp;id_address_delivery=".$_tmp40."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp43=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp41."&amp;ipa=".$_tmp42."&amp;id_address_delivery=".$_tmp43."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp46=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp44."&amp;ipa=".$_tmp45."&amp;id_address_delivery=".$_tmp46."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
